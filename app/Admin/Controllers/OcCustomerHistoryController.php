...
use App\Models\OcCustomerHistory;
...
class OcCustomerHistoryController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerHistory());
        ...
        {
                $form = new Form(new OcCustomerHistory());
        ...
        {
        $show = new Show(OcCustomerHistory::findOrFail($id));
