...
use App\Models\OcAttributeGroupDescription;
...
class OcAttributeGroupDescriptionController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcAttributeGroupDescription());
        ...
        {
                $form = new Form(new OcAttributeGroupDescription());
        ...
        {
        $show = new Show(OcAttributeGroupDescription::findOrFail($id));
