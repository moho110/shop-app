...
use App\Models\OcCouponHistory;
...
class OcCouponHistoryController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCouponHistory());
        ...
        {
                $form = new Form(new OcCouponHistory());
        ...
        {
        $show = new Show(OcCouponHistory::findOrFail($id));
