...
class OcBannerImageController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcBannerImage());
        ...
        {
                $form = new Form(new OcBannerImage());
        ...
        {
        $show = new Show(OcBannerImage::findOrFail($id));
