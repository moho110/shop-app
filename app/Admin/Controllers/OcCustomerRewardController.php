...
use App\Models\OcCustomerReward;
...
class OcCustomerRewardController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerReward());
        ...
        {
                $form = new Form(new OcCustomerReward());
        ...
        {
        $show = new Show(OcCustomerReward::findOrFail($id));
