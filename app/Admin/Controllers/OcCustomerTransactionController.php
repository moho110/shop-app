...
use App\Models\OcCustomerTransaction;
...
class OcCustomerTransactionController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerTransaction());
        ...
        {
                $form = new Form(new OcCustomerTransaction());
        ...
        {
        $show = new Show(OcCustomerTransaction::findOrFail($id));
