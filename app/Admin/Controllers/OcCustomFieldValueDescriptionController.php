...
use App\Models\OcCustomFieldValueDescription;
...
class OcCustomFieldValueDescriptionController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomFieldValueDescription());
        ...
        {
                $form = new Form(new OcCustomFieldValueDescription());
        ...
        {
        $show = new Show(OcCustomFieldValueDescription::findOrFail($id));
