...
use App\Models\OcCustomerGroup;
...
class OcCustomerGroupController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerGroup());
        ...
        {
                $form = new Form(new OcCustomerGroup());
        ...
        {
        $show = new Show(OcCustomerGroup::findOrFail($id));
