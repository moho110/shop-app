...
use App\Models\OcCustomerActivity;
...
class OcCustomerActivityController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerActivity());
        ...
        {
                $form = new Form(new OcCustomerActivity());
        ...
        {
        $show = new Show(OcCustomerActivity::findOrFail($id));
