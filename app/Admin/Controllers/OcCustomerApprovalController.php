...
use App\Models\OcCustomerApproval;
...
class OcCustomerApprovalController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerApproval());
        ...
        {
                $form = new Form(new OcCustomerApproval());
        ...
        {
        $show = new Show(OcCustomerApproval::findOrFail($id));
