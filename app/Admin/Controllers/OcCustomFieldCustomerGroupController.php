...
use App\Models\OcCustomFieldCustomerGroup;
...
class OcCustomFieldCustomerGroupController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomFieldCustomerGroup());
        ...
        {
                $form = new Form(new OcCustomFieldCustomerGroup());
        ...
        {
        $show = new Show(OcCustomFieldCustomerGroup::findOrFail($id));
