...
use App\Models\OcCouponCategory;
...
class OcCouponCategoryController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCouponCategory());
        ...
        {
                $form = new Form(new OcCouponCategory());
        ...
        {
        $show = new Show(OcCouponCategory::findOrFail($id));
