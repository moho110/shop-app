...
use App\Models\OcCouponProduct;
...
class OcCouponProductController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCouponProduct());
        ...
        {
                $form = new Form(new OcCouponProduct());
        ...
        {
        $show = new Show(OcCouponProduct::findOrFail($id));
