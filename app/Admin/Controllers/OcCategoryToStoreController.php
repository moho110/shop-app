...
class OcCategoryToStoreController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCategoryToStore());
        ...
        {
                $form = new Form(new OcCategoryToStore());
        ...
        {
        $show = new Show(OcCategoryToStore::findOrFail($id));
