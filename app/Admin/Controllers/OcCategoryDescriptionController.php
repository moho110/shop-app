...
class OcCategoryDescriptionController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCategoryDescription());
        ...
        {
                $form = new Form(new OcCategoryDescription());
        ...
        {
        $show = new Show(OcCategoryDescription::findOrFail($id));
