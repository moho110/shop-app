...
class OcCategoryController extends AdminController {

	protected $title = "Category List";
    ...
    protected function grid() {
        ...
        {
        $show = new Show(OcCategory::findOrFail($id));
