...
class OcCategoryToLayoutontroller extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCategoryToLayout());
        ...
        {
                $form = new Form(new OcCategoryToLayout());
        ...
        {
        $show = new Show(OcCategoryToLayout::findOrFail($id));
