...
use App\Models\OcCustomerWishlist;
...
class OcCustomerWishlistController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerWishlist());
        ...
        {
                $form = new Form(new OcCustomerWishlist());
        ...
        {
        $show = new Show(OcCustomerWishlist::findOrFail($id));
