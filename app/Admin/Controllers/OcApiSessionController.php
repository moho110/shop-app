...
class OcApiSessionController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcApiSession());
        ...
        {
                $form = new Form(new OcApiSession());
        ...
        {
        $show = new Show(OcApiSession::findOrFail($id));
