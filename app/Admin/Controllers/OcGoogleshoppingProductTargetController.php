...
class OcGoogleshoppingProductTargetController extends AdminController {
    ...
    protected function grid() {
        ...
        {
        $show = new Show(OcAddress::findOrFail($id));
