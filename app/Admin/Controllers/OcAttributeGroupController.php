...
use App\Models\OcAttributeGroup;
...
class OcAttributeGroupController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcAttributeGroup());
        ...
        {
                $form = new Form(new OcAttributeGroup());
        ...
        {
        $show = new Show(OcAttributeGroup::findOrFail($id));
