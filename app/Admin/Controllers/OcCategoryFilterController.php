...
class OcCategoryFilterController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCategoryFilter());
        ...
        {
                $form = new Form(new OcCategoryFilter());
        ...
        {
        $show = new Show(OcCategoryFilter::findOrFail($id));
