...
use App\Models\OcCustomFieldValue;
...
class OcCustomFieldValueController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomFieldValue());
        ...
        {
                $form = new Form(new OcCustomFieldValue());
        ...
        {
        $show = new Show(OcCustomFieldValue::findOrFail($id));
