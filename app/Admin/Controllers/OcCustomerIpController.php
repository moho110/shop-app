...
class OcCustomerIpController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerIp());
        ...
        {
                $form = new Form(new OcCustomerIp());
        ...
        {
        $show = new Show(OcCustomerIp::findOrFail($id));
