...
use App\Models\OcCustomerLogin;
...
class OcCustomerLoginController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerLogin());
        ...
        {
                $form = new Form(new OcCustomerLogin());
        ...
        {
        $show = new Show(OcCustomerLogin::findOrFail($id));
