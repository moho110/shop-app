...
use App\Models\OcCustomerSearch;
...
class OcCustomerSearchController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerSearch());
        ...
        {
                $form = new Form(new OcCustomerSearch());
        ...
        {
        $show = new Show(OcCustomerSearch::findOrFail($id));
