...
use App\Models\OcCustomerAffiliate;
...
class OcCustomerAffiliateController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerAffiliate());
        ...
        {
                $form = new Form(new OcCustomerAffiliate());
        ...
        {
        $show = new Show(OcCustomerAffiliate::findOrFail($id));
