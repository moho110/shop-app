...
class OcCategoryPathController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCategoryPath());
        ...
        {
                $form = new Form(new OcCategoryPath());
        ...
        {
        $show = new Show(OcCategoryPath::findOrFail($id));
