...
class OcAttributeDescriptionController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcAttributeDescription());
        ...
        {
                $form = new Form(new OcAttributeDescription());
        ...
        {
        $show = new Show(OcAttributeDescription::findOrFail($id));
