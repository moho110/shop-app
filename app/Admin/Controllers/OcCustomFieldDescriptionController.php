...
use App\Models\OcCustomFieldDescription;
...
class OcCustomFieldDescriptionController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomFieldDescription());
        ...
        {
                $form = new Form(new OcCustomFieldDescription());
        ...
        {
        $show = new Show(OcCustomFieldDescription::findOrFail($id));
