...
use App\Models\OcCustomerOnline;
...
class OcCustomerOnlineController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerOnline());
        ...
        {
                $form = new Form(new OcCustomerOnline());
        ...
        {
        $show = new Show(OcCustomerOnline::findOrFail($id));
