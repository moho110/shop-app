...
use App\Models\OcCustomerGroupDescription;
...
class OcCustomerGroupDescriptionController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomerGroupDescription());
        ...
        {
                $form = new Form(new OcCustomerGroupDescription());
        ...
        {
        $show = new Show(OcCustomerGroupDescription::findOrFail($id));
