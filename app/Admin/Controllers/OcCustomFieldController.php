...
class OcCustomFieldController extends AdminController {
    ...
    protected function grid() {
                $grid = new Grid(new OcCustomField());
        ...
        {
                $form = new Form(new OcCustomField());
        ...
        {
        $show = new Show(OcCustomField::findOrFail($id));
