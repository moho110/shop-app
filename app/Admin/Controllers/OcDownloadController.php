...
class OcDownloadController extends AdminController {
    ...
    protected function grid() {
        ...
        {
        $show = new Show(OcDownload::findOrFail($id));
