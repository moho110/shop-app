				...
				<div class="col-lg-4 col-md-6">
					<div class="footer-widget mb-50">
						<div class="footer-logo mb-30">
							<a href="index.html"><img src="static/home/img/logo/logo_black.png" alt=""></a>
						</div>
					...
					<div class="footer-widget mb-50">
						...
						<div class="footer-contact">
							<ul>
								...
								<li><i class="fas fa-envelope-open"></i><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bdeec8cdcdd2cfc9fdd4d3dbd293fed2d0">[email&#160;protected]</a></li>
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-6 col-md-6 d-none d-md-block">
					<div class="payment-method-img text-right">
						<img src="static/home/img/images/card_img.png" alt="img">
					</div>
				</div>
			</div>
		</div>
